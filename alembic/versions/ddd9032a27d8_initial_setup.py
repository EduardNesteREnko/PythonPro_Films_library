...
Revises: 
Create Date: 2026-01-28 12:55:36.648100
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('genre_id', sa.String(length=100), nullable=False),
    ...
    op.create_foreign_key(None, 'filmlist', 'list', ['list_id'], ['id'])
    op.create_foreign_key(None, 'filmlist', 'film', ['film_id'], ['id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'filmlist', type_='foreignkey')
    op.drop_constraint(None, 'filmlist', type_='foreignkey')
    op.drop_table('list')
